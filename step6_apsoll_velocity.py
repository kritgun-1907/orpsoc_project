...
# level, so `import step6_apsoll_velocity` runs the entire thing as a side effect --
...
if globals().get("__name__", "__main__") != "__main__":
    raise ImportError(
        "step6_apsoll_velocity.py is a script, not an importable module -- importing it would "
