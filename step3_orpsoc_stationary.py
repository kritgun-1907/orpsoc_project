...
# level, so `import step3_orpsoc_stationary` runs the entire thing as a side effect --
...
if globals().get("__name__", "__main__") != "__main__":
    raise ImportError(
        "step3_orpsoc_stationary.py is a script, not an importable module -- importing it would "
