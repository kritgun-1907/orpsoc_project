...
# level, so `import step5_hmm_detector` runs the entire thing as a side effect --
...
if globals().get("__name__", "__main__") != "__main__":
    raise ImportError(
        "step5_hmm_detector.py is a script, not an importable module -- importing it would "
